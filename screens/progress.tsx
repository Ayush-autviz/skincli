...
export default function ProgressTab(): React.JSX.Element {
  ...
  const { topConcerns: apiTopConcerns, setTopConcerns: setApiTopConcerns } =
    useAuthStore();
  ...
  const fetchComparisonData = async (
    ...
    try {
      ...
      if ((response as any).success && (response as any).data) {
        ...
        console.log(
          `✅ Loaded ${transformedPhotos.length} photos for progress display`,
        );
    ...
    <View style={styles.errorContainer}>
      <View style={styles.errorContent}>
        ...
        <Text style={styles.errorSubtext}>
          {error?.message ||
            'Something went wrong while loading your progress data'}
        </Text>
    ...
    <View style={styles.noDataContainer}>
      <View style={styles.emptyContent}>
        ...
        <Text style={styles.noDataText}>
          Track your skin health and the efficacy of your skin care
        </Text>
        <Text style={styles.noDataSubtext}>
          On your first visit, take 2 photos to activate the tracker, then as
          often as you want!
        </Text>
      </View>
    </View>
  ...
  return (
    <View style={styles.container}>
      <HomeHeader onMenuPress={handleMenuPress} title="Progress" />
...
const styles = StyleSheet.create({
  ...
  content: {
    flex: 1,
    marginTop: Platform.OS === 'ios' ? 100 : 80, // Space for new header
